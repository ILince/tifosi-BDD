...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 27 mai 2024 à 20:50
...
INSERT INTO `achete` (`id_achete`, `id_client`, `id_focaccia`, `jour`) VALUES
(1, 1, 2, '2024-05-27 21:46:21'),
(2, 2, 6, '2024-05-27 22:01:47'),
(3, 2, 8, '2024-05-27 22:01:47');
...
CREATE TABLE IF NOT EXISTS `client` (
  ...
  `nom-client` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  `age` int NOT NULL,
...
INSERT INTO `client` (`id_client`, `nom-client`, `age`, `cp-client`) VALUES
(1, 'Paul', 21, 1233),
(2, 'Fanny', 43, 857);
...
--
-- Déchargement des données de la table `est_constitué`
--

INSERT INTO `est_constitué` (`id_menu`, `id_focaccia`) VALUES
(1, 2),
(1, 2);
...
CREATE TABLE IF NOT EXISTS `focaccia` (
  ...
  `nom_foccacia` varchar(45) COLLATE utf8mb4_bin NOT NULL,
...
INSERT INTO `paye` (`id_paye`, `id_client`, `id_menu`, `jour`) VALUES
(1, 1, 1, '2024-05-27 21:59:36'),
(2, 2, 2, '2024-05-27 22:11:00'),
(3, 2, 1, '2024-05-27 22:11:00');
